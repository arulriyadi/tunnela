...
Dokumen ini merangkum isi repo [WGDashboard/WGDashboard](https://github.com/WGDashboard/WGDashboard) dari struktur folder sampai alur kode utama. Versi konfigurasi di kode mengacu ke `DashboardConfig.DashboardVersion` (saat ini **v4.3.2** di `modules/DashboardConfig.py`).
