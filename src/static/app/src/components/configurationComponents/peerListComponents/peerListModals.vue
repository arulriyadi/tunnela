...
const resolvedConfigurationName = computed(() =>
	props.configurationModalSelectedPeer?.configuration?.Name || props.fallbackConfigurationName || undefined
)
...
<template>
	<TransitionGroup name="zoom">
		<PeerSettingsModal 
			...
			:configurationName="resolvedConfigurationName"
