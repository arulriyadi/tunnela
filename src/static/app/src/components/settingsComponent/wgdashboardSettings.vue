...
import DashboardNginxReverseProxyCard from "@/components/settingsComponent/dashboardNginxReverseProxyCard.vue";
...
import DashboardClientsStatisticsInterval from "@/components/settingsComponent/dashboardClientsStatisticsInterval.vue";
import DashboardTimezone from "@/components/settingsComponent/dashboardTimezone.vue";
import DashboardLoginCopyright from "@/components/settingsComponent/dashboardLoginCopyright.vue";
...
<template>
	<div class="d-flex gap-3 flex-column">
		...
		<div class="card rounded-3">
			<div class="card-header">
				<h6 class="my-2">
					...
					<LocaleText t="Date & time"></LocaleText>
				</h6>
			</div>
			<div class="card-body">
		...
		<div class="card rounded-3">
			<div class="card-header">
				<h6 class="my-2">
					...
					<LocaleText t="Dashboard listen (TCP or Unix socket)"></LocaleText>
				</h6>
			</div>
			<div class="card-body">
		...
		<DashboardNginxReverseProxyCard></DashboardNginxReverseProxyCard>
		<div class="card rounded-3">
			<div class="card-header">
				<h6 class="my-2">
					<i class="bi bi-graph-up-arrow me-2"></i>
					<LocaleText t="Clients list statistics"></LocaleText>
				</h6>
			</div>
			<div class="card-body">
				<DashboardClientsStatisticsInterval></DashboardClientsStatisticsInterval>
			</div>
		</div>
		<div class="card rounded-3">
			<div class="card-header">
		...
		<div class="card rounded-3">
			<div class="card-header">
				<h6 class="my-2">
					...
					<LocaleText t="Sign-in copyright"></LocaleText>
				</h6>
			</div>
			<div class="card-body">
				<DashboardLoginCopyright></DashboardLoginCopyright>
			</div>
		</div>
	</div>
</template>
