	...
	routes: [
		{
			...
			children: [
				...
				{
					name: "WireGuard Management Home",
					path: "wireguard_management",
				...
				},
				{
					...
					path: "wireguard_configuration",
					component: () => import("@/views/wireguardConfiguration.vue"),
					redirect: { name: "WireGuard Configuration New" },
					meta: {
						title: "WireGuard Configuration"
					},
					children: [
						{
							name: "WireGuard Configuration New",
							path: "new",
						...
						{
							name: "WireGuard Configuration Restore",
							path: "restore",
				...
				},
				{
					...
					redirect: { name: "WireGuard Configuration Restore" }
				},
				{
					name: "System Status",
					path: 'system_status',
	...
	if (to.meta.requiresAuth){
		if (!dashboardConfigurationStore.getActiveCrossServer()){
			if (await checkAuth()){
				...
				if (!wireguardConfigurationsStore.Configurations && to.name !== "WireGuard Management Home"){
